...
/**
 * <h1>PlayerAction</h1>
 * Responsible for receiving player's commands and determing outcome. Receives
 * method calls from ui layer (ui.KeyListener to be more specific). Determines
 * the consequence of player input, mainly if the player can move to a given
 * direction.
 */
public class PlayerController {
    ...
    /**
     * Used to determine if player input is resolved or not. Set to false during
     * monster turn.
     *
    ...
    /**
     * Tell's PlayerController that the game is running and player input should
     * be resolved. Set to true in the beginning of the game and false in the
     * end of the game.
     *
